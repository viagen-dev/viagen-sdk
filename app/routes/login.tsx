...
export default function Login() {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem', width: 260 }}>
        <a href={`/api/auth/login/github${returnParam}`} style={styles.button}>
          <GitHubIcon />
          Continue with GitHub
        </a>
        <a href={`/api/auth/login/google${returnParam}`} style={styles.button}>
          <GoogleIcon />
